...
public class Gugecrawl {
    public static void main(String[] args) throws IOException {
        ...
        PrintStream ps = new PrintStream("D:\\zywj\\gugezpsj\\谷歌招聘数据.txt");// 创建文件输出流1
...
//                        System.out.print("职业:" + o.getString("job_name"));
//                        System.out.print("工资:" + o.getString("providesalary_text"));
//                        System.out.print("待遇:" + o.getString("jobwelf"));
//                        System.out.print("发布时间:" + o.getString("issuedate"));
...
//                        String s = str[0].replace('[', ' ');
//                        String a = s.replace(']', ' ');
//                        System.out.print("地点:" + a.replace('"', ' '));
//                        String sq = str[1].replace('[', ' ');
//                        String aq = sq.replace(']', ' ');
//                        System.out.print("资历：" + aq.replace('"', ' '));
//                        if(str.length <3) {
//                        	System.out.print("学历：" +"大专");
//                       }
//                        else {
//                        String sw = str[2].replace('[', ' ');
//                        String aw = sw.replace(']', ' ');
